...
> **Связанные проекты:** OpenWrt-пакеты (LuCI веб-интерфейс + CLI `xray-status`) вынесены в отдельный репозиторий [XPowerSpirit-WebUI](https://github.com/kirilllavrov/XPowerSpirit-WebUI).
